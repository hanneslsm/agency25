...
echo sprintf( esc_html__( '%1$s404%2$s', 'agency25' ), '<strong>', '</strong>' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","level":1,"style":{"typography":{"fontSize":"4rem"}}} -->
<h1 class="wp-block-heading has-text-align-center" style="font-size:4rem"><?php esc_html_e('Not Found', 'agency25');?></h1>
<!-- /wp:heading --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e('The resource requested could not be found on this server.', 'agency25');?></p>
<!-- /wp:paragraph -->
